...
```
/?nativeLangCode=vi&studyLangCode=en&authCode=tach
```
...
| `studyLangCode` | `en` |
| `authCode` | bắt buộc — mock hợp lệ: `tach` |
...
```
http://localhost:5173/?nativeLangCode=vi&studyLangCode=en&authCode=tach
```
